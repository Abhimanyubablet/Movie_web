...
export default function MovieDetails() {
  ...
  return (
    <div>
      ...
      <section style={{background:`url(https://image.tmdb.org/t/p/original${moviedetails.poster_path})`,height:"800px" ,backgroundPosition:"center",backgroundSize:"cover",backgroundRepeat:"no-repeat"}} className="movie-detail" >
        <div className="container">

          <figure className="movie-detail-banner">

            <img style={{width:"100%",height:"400px"}} src={`https://image.tmdb.org/t/p/original${moviedetails.backdrop_path}`} alt="Free guy movie poster"/>
          ...
          <div className="movie-detail-content">
           ...
           {Type.includes("movie") ? moviedetails.title : moviedetails.name }
            </h1>
            <div className="meta-wrapper">
              ...
              <div className="date-time">
                ...
                <div>
                  ...
                  <time datetime="2021"> {moviedetails.release_date} </time>
                </div>

                <div>
                  <ion-icon name="time-outline"></ion-icon>

                  <time datetime="PT115M"> {moviedetails.runtime} </time>
                </div>
            ...
            <p className="detail-subtitle"> Status:{moviedetails.status} ,Popularity:{moviedetails.popularity}  </p>
