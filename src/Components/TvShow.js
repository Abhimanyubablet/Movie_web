...
export default function TvShow() {
  ...
  return (
    <>
    <Navbar/>
    <div className="Banner_TvShow">
            <div className="Text_TvShow">
              <h1 className="Heading_TvShow" >Trending TvShow </h1>
              <p className="lorem_TvShow">Lorem ipsum dolor sit amet conse adipisicing elit. Doloremque sunt adipisci asperiores dolor, doloribus libero suscipit error, corrupti autem dicta, consequatur dolorum. Sunt reprehenderit.lorem  doloribus libero  error.</p>
            </div>
     </div>
     <div style={{textAlign:"center", marginTop:"2vh", color:"yellow"}}>
       <h1>All Tvshow Available</h1>
       </div>
